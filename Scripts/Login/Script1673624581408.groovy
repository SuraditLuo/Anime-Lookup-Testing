...
WebUI.click(findTestObject('Object Repository/Page_MAL_Project/div_Discovery_input'))
...
WebUI.click(findTestObject('Object Repository/Page_MAL_Project/h4_Hello, TokiDokor'))
